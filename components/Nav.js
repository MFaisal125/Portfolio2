...
const Nav = () => {
  ...
  return (
    ...
    >
      {/*hello hina*/}
      <div
        className="items-center xl:justify-center flex xl:flex-col justify-between gap-y-10 w-full
        ...
        {navData.map((link, index) => {
          return (
            <Link
              ...
              } items-center relative flex group hover:text-accent transition-all duration-300`}
              href={link.path}
              key={index}
            >
